 ...
 <div class="col-md-3">
  <form id="form-reset-password">
    <div class="form-group">
      ...
      <div class="form-group">
        <input type="password" class="form-control" name="password" placeholder="Type in password" id="password-update1">
      </div>
      <div class="form-group">
        <input type="password" class="form-control"  placeholder="Repeat password" id="password-update2">
        <input type="hidden" name="_token" value="{{Session::token()}}">
      </div>
      <button class="btn btn-slick" id="reset-password">Reset</button>
