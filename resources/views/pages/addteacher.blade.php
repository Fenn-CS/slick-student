            ...
            <form role="form">
              ...
              <div class="col-md-4">
               <div class="form-group">
                <label for="matricule">Matricule Number/Employee No</label>
                <input type="text" class="form-control" name="matricule" placeholder="UB15HA15">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="DR NKWETEYIM">
              </div>
              <div class="form-group">
